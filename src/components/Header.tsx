...
const Header = () => {
  ...
  return (
    <>
      {/* Top Banner */}
      <div className="bg-gradient-to-r from-amber-900 via-amber-800 to-amber-900 text-white text-center py-2 text-sm">
      ...
      {/* Main Header */}
      <header className="bg-[#3E2723] sticky top-0 z-50 shadow-lg">
            ...
            <div className="lg:hidden mt-4 pb-4 border-t border-amber-800/50">
              <div className="flex flex-col space-y-3 pt-4">
                ...
                <div className="flex items-center gap-6 pt-3 border-t border-amber-800/50">
                  ...
                  {user && (
                    <button onClick={() => { logout(); setIsMenuOpen(false); }} className="text-red-300 hover:text-red-200">
                      Logout
                    </button>
                  )}
                </div>
